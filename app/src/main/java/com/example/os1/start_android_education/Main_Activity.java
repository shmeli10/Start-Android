    ...
    private void moveForward(int position) {
        ...
        switch(position) {
            ...
            case 73: intent = new Intent(Main_Activity.this,Lesson74_RunnableUIThread.class);
                     break;
            case 74: intent = new Intent(Main_Activity.this,Lesson75_AsyncTask.class);
                     break;
            case 75: intent = new Intent(Main_Activity.this,Lesson76_AsyncTaskParams.class);
                     break;
            ...
            case 83: intent = new Intent(Main_Activity.this,Lesson84_ServiceBackPendingIntent.class);
                     break;
            case 84: intent = new Intent(Main_Activity.this,Lesson85_ServiceBackBroadcast.class);
                     break;
            ...
            case 87: intent = new Intent(Main_Activity.this,Lesson88_ServiceNotification.class);
                     break;
            case 88: intent = new Intent(Main_Activity.this,Lesson89_ContentProviderClient.class);
                     break;
            ...
            case 95: intent = new Intent(Main_Activity.this,Lesson96_ActionBarNavigation.class);
                     break;
            case 96: intent = new Intent(Main_Activity.this,Lesson97_ListFragment.class);
                     break;
            ...
            case 104: break;
            case 105: break;
            case 106: intent = new Intent(Main_Activity.this,Lesson107_PendingIntent.class);
                      break;
            case 107: break;
            case 108: break;
            case 109: break;
            case 110: intent = new Intent(Main_Activity.this,Lesson125_GoogleMaps.class);
                      break;
        }
